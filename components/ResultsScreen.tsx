    ...
    <div className="bg-background-light font-sans antialiased transition-colors duration-300 min-h-screen w-full max-w-md mx-auto relative overflow-hidden">
      ...
      <main className="px-6 pt-8 pb-12 relative z-10">
        ...
        <header className="mb-12 text-center animate-fade-in-up">
          <div className="inline-block transform -rotate-1 bg-accent-peach/30 px-4 py-1 rounded-full border border-primary/20 mb-4">
            <span className="font-script text-primary text-xl">L'Evoluzione</span>
          </div>
        ...
        <article className="space-y-12">
          ...
          <section className="space-y-8">
            ...
            <div className="grid gap-6">
              {[
                { icon: 'biotech', color: 'text-primary', bg: 'bg-accent-peach/20', title: '1. CUIDE DO INTESTINO (Sua fábrica de humor)', desc: '90% da sua Serotonina é produzida no intestino! Coma fibras (frutas, verduras, aveia). O intestino preso ou inflamado aumenta a irritabilidade e a busca por compensação na comida.' },
